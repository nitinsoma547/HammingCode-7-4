...
export const metadata: Metadata = {
  title: "Contact",
  description: `Find ${brand.name} — hours, phone, address, directions.`,
};
    ...
    <main>
      <header className="px-6 md:px-12 lg:px-20 pt-16 pb-10 md:pt-20 md:pb-14">
        ...
        <p className="text-base md:text-lg opacity-75 max-w-2xl mt-4 leading-relaxed">
          Walk-ins welcome. For large orders call ahead — we plate one
          dosa at a time and the kitchen needs the head start.
        </p>
      </header>
